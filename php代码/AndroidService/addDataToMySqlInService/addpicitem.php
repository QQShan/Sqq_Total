...
<form  id="theForm" name="theForm" action="addpicitem_chk.php" method="post" enctype="multipart/form-data">
 <tr><td colspan="3" height="32"><h1 align="center">添加图片信息</h1></td></tr>
 <tr>
   <td width="120" height="28"><div align="center">标题:</div></td>
   <td><input class="input2"  type="text" name="itemTitle" /></td>
   <td align="left" width="180" ><span class="sp1">*填写图片信息标题</span></td> 
 </tr>
 <tr>
