 ...
 * 这种添加头部的方式，对现在做的轮播图不支持
 */
public class PlusRecyclerViewAdapter extends RecyclerViewAdapterWrapper {
    ...
    public PlusRecyclerViewAdapter(RecyclerView.Adapter wrapped) {
        super(wrapped);
    }
