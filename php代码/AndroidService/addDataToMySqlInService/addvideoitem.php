...
<form  id="theForm" name="theForm" action="addvideoitem_chk.php" method="post" enctype="multipart/form-data">
 <tr><td colspan="3" height="32"><h1 align="center">添加视频信息</h1></td></tr>
 <tr>
 ...
 <tr>
  ...
  <tr>
   <td height="28"><div align="center">视频地址:</div></td>
   <td><input class="input2" type="text" name="videoUrl" /></td>
   <td align="left" width="180"><span class="sp1">*填写视频地址&nbsp;&nbsp;</span></td> 
 </tr>
